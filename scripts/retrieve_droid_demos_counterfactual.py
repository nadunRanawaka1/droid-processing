...
def create_datasets_for_object(object):
...
counterfactual_color_df = None
counterfactual_campose_df = None

for obj in object_list:
    object_df, spatial_df, color_df, campose_df = create_datasets_for_object(obj)
    if counterfactual_object_df is None:
        counterfactual_object_df = object_df
        counterfactual_campose_df = campose_df
        counterfactual_color_df = color_df
        counterfactual_spatial_df = spatial_df
    else:
        counterfactual_object_df = pd.concat([counterfactual_object_df, object_df], ignore_index=True)
