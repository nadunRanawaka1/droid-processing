...
def create_agentview_dicts(demo_fn, processed_datasets_folder):
    ...
    # # CREATE TARGET DATASET (SHOULDERVIEW LEFT AS AGENTVIEW)
    target_dict =  {"shoulderview_left_image": deepcopy(demo_list)}
    target_dict_path = os.path.join(processed_datasets_folder, "target_dataset.hdf5")

    dict_list.append((target_dict, target_dict_path))
    ...
    # shoulderview_right_image_dict_path = os.path.join(processed_datasets_folder, "shoulderview_right_as_agentview.hdf5")
    ...
    # shoulderview_left_image_dict_path = os.path.join(processed_datasets_folder, "shoulderview_left_image_as_agentview.hdf5")
    ...
    # left_right_image_dict_path = os.path.join(processed_datasets_folder, "left_and_right_image_as_agentview.hdf5")
    ...
    # right_shoulderview_right_dict_path = os.path.join(processed_datasets_folder, "right_image_and_shoulderview_right_as_agentview.hdf5")
